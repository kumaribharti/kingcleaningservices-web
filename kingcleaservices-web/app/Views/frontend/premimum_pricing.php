...
<section class="page-header">
    ...
    <div class="container">
        <div class="page-header__inner">
            <h2>Premimum Deep Cleaning Prices</h2>
            <ul class="thm-breadcrumb">
                <li><a href="<?php echo base_url(); ?>">Home</a></li>
                <li><span>/</span></li>
                <li>Premimum Deep Cleaning Prices</li>
            </ul>
        </div>
    </div>
</section>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link  active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                        type="button" role="tab" aria-controls="home" aria-selected="true">Bathroom Cleaning</button>
                </li>
                <li class="nav-item" role="presentation">
                        ...
                        <div class="container">
                            <div class="mb-md-5 mb-3 uuu">
                                <ul style="list-style-type: disc;">
                                    ...
                                    <li>Cupboard should be empty.</li>
