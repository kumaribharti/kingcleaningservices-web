                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Table Data List</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Table Data</a></li>
                                        <li class="breadcrumb-item active">Table Data List</li>
                                    </ol>
                                </div>
                                    ...
                                    <div class="table-responsive table-card mb-4">
                                        <table class="table  align-middle mb-5" id="myTable">
                                            ...
                                            <?php $i=1; foreach ($table_data as $table_data) : ?>
                                              ...
                                              <td><?php echo $table_data['category_name'];?></td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <li class="dropdown-divider"></li>
                                                                <li>
                                                                    <a data-bs-toggle="modal" data-bs-target="#removeNotificationModal<?php echo $table_data['table_id'];?>" class="dropdown-item" href="#"><i class="fa  fa-trash"></i>
                                                                        Delete</a>
                                                                </li>
                                                                <li>
                                                                    <a  class="dropdown-item" href="<?php echo base_url('admin/edit_tabel_data/');?><?php echo $table_data['table_id'];?>"><i class="las la-pen fs-18 align-middle me-2 text-muted"></i>
                                                                        Edit</a>
                                                                </li>
...
<div id="removeNotificationModal<?php echo $table_data['table_id'];?>" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                    ...
                    <a href="<?php echo base_url()?>admin/delete_table_data/<?php echo $table_data['table_id'];?>" type="button" class="btn w-sm btn-danger" id="delete-notification">Yes, Delete It!</a>
                </div>
            </div>
...
<div class="modal fade mt-5" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Add table data</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <form   action="<?php echo base_url('admin/add_data_in_table');?>" method="post">
      <div class="row">
        <div class="col-12">
        <div class="mb-3">
        ...
        <div class="mb-3">
                ...
                <input type="text"  class="form-control"  name="field_2" required>
            </div>
        </div><!--end col-->
        <div class="col-12">
        <div class="mb-3">
                <label for="emailidInput" class="form-label">Field 3</label>
                <input type="text"  class="form-control"  name="field_3" required>
            </div>
        </div><!--end col-->
        <div class="col-md-12">
            <div class="mb-3">
